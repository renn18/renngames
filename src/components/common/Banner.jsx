    ...
    <BannerWrapper className='d-flex align-items-center justify-content-start' style={
      {
        ...
        38.46%), url(${banner_image}) center/cover no-repeat`
      }
    }>
      <div className="banner-content w-100 container text-white">
        <div className="banner-badge text-uppercase">join streaming</div>
        <h1 className="banner-title text-uppercase">set online game to play</h1>
        <p className="lead-text">Live gaming with lots of other games. Lorem ipsum, dolor sit amet consectetur adipisicing elit. Consequatur blanditiis officia facilis nulla! Quia perferendis quibusdam aspernatur eaque soluta dolor, sequi optio dolorum accusamus minus eos, quidem repellat.</p>
