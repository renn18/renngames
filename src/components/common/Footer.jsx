    ...
    <FooterWrapper>
        ...
        <div className="footer-content text-white d-grid container">
          <div className="footer-item">
            <a href="#" className='navbar-brand text-white text-uppercase no-wrap d-block'>
              renn <span>games</span>
            </a>
            <p className="para-text">Lorem ipsum dolor sit amet consectetur, adipisicing elit. Praesentium, sunt.</p>
          </div>
      ...
      <div className="footer-bottom">
        <div className="container d-flex flex-column text-center">
          <p className="footer-bottom-text text-white">Copyright &copy; 2024 Muhammad Putra Pratama - All rights reserved.</p>
