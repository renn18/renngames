    ...
    <GameDetailsWrapper>
      ...
      <div className="details-grid d-grid">
        ...
        <div className="details-right">
          ...
          <div className="para-text" dangerouslySetInnerHTML={{ __html: (gameData?.description)?.split('.').splice(0, 3).join('.') + "." }}></div>
      ...
      <Tabs>
                ...
                return (
                  <div className='platform-item text-white' key={item?.platform?.id}>
                    ...
                    <div className="platform-img-wrapper img-fit-cover">
                      <img src={item?.platform?.image_background} className='platform-img' alt={item?.platform?.name} />
                    </div>
                  </div>
                )
              })
        ...
        <TabPanel>
          ...
          <div className="card-list">
            {
              gameData?.stores?.map(item => (<StoreItem key={item?.store?.id} storeItem={item?.store} />))
            }
          </div>
